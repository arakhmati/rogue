        ...
        _entities=pmap(
            {
                Entity(unique_id=4): pmap(
                    {
                        "AppearanceComponent": AppearanceComponent.create_from_attributes(symbol="!", color="blue"),
                        "PositionComponent": PositionComponent.create_from_attributes(y_axis=21, x_axis=24),
                    }
                ),
                Entity(unique_id=5): pmap(
                    {
                        "AppearanceComponent": AppearanceComponent.create_from_attributes(symbol="*", color="gold"),
                ...
                Entity(unique_id=6): pmap(
                    {
                        "AppearanceComponent": AppearanceComponent.create_from_attributes(symbol="+", color="grey"),
                ...
                Entity(unique_id=1): pmap(
                    {
                        "AppearanceComponent": AppearanceComponent.create_from_attributes(symbol="(", color="green"),
                        "PositionComponent": PositionComponent.create_from_attributes(y_axis=16, x_axis=23),
                    }
                ),
                Entity(unique_id=2): pmap(
                    {
                        "AppearanceComponent": AppearanceComponent.create_from_attributes(symbol="H", color="red"),
                ...
                Entity(unique_id=3): pmap(
                    {
                        "AppearanceComponent": AppearanceComponent.create_from_attributes(symbol="#", color="purple"),
